...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.tvNameCategory.setText(transaction.getNameCategory());
        viewHolder.tvDescription.setText(transaction.getDescription());
        viewHolder.tvPrice.setText(String.valueOf(transaction.getAmount()) + " đ");
        viewHolder.tvPrice2.setText(String.valueOf(transaction.getAmount()) + " đ");
